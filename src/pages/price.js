    ...
    <section id="two">
      <div className="inner">
        ...
        <table className="alt">
          ...
          <tbody>
            <tr><td>半日券<span>*5</span><br />（6時間）</td><td>¥2,310</td><td>¥1,760</td></tr>
            <tr><td>1日券<span>*5</span><br />（開店〜閉店）</td><td>¥2,860</td><td>¥2,310</td></tr>
          </tbody>
        </table>
        <hr />
        <h3>回数券・パスポート</h3>
        ...
        <p className="small">
          ...
          *5:混雑状況によって入場制限をする場合がございます。<br /><!-- 事前に<a href="https://docs.google.com/forms/d/e/1FAIpQLSdkfqWiBSGoy5viXovQ6GVxJgJQ_P4uOHisevQjkfCzAch6mw/viewform" target="_blank">予約フォーム</a>でご予約いただくとスムーズです。一日利用の場合は「開店〜15時」の枠でご予約ください。 --> 
