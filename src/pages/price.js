      ...
      <div className="inner">
        ...
        <table className="alt">
          ...
          <tbody>
            ...
            <tr><td>夜2・21時〜閉店<span>*1</span></td><td>¥1,320</td><td>¥1,100</td></tr>
          </tbody>
        </table>
        <hr />
        <h3>土日・祝日のメニュー</h3>
        <table className="alt">
          ...
          <tbody>
            <tr><td>二部制（一日券は中止）<span>*5</span><br />①開店〜14時<br />②14時〜閉店</td><td>¥2,200</td><td>¥1,650</td></tr>
            <tr><td>夜・18時〜閉店<span>*1</span></td><td>¥1,650</td><td>¥1,320</td></tr>
          </tbody>
        </table>
        <hr />
        ...
        <hr />
        <p className="small">
          *1:「夜・18時〜閉店」「夜2・21時〜閉店」 でのご利用の際には、 閉店時間の変動に関わらず閉店までとさせていただきます。営業時間の詳細は<Link to="/guide">こちら</Link>でご確認ください。<br />
          ...
          *5:コロナ禍対応として土日・祝日は予約制でのご利用となります。<a href="https://docs.google.com/forms/d/e/1FAIpQLSdkfqWiBSGoy5viXovQ6GVxJgJQ_P4uOHisevQjkfCzAch6mw/viewform" target="_blank">予約フォーム</a>からお申し込みください。尚、ご利用は二部入れ替え制（開店〜14時／14時〜閉店）となっており、人数制限を行う関係から利用枠ごとに料金が発生いたします。予めご了承ください。各枠での入館時間は自由です。ご都合に合わせてお越しください。<br />
