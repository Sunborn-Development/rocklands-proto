      ...
      <div className="inner">
        ...
        <table className="alt">
          ...
          <tbody>
            ...
            <tr><td>昼・開店〜18時半</td><td>¥1,760</td><td>¥1,650</td></tr>
            <tr><td>夜・18時〜閉店<span>*1</span></td><td>¥1,980</td><td>¥1,650</td></tr>
          </tbody>
        </table>
        <hr />
        <h3>土日・祝日のメニュー</h3>
        <table className="alt">
          ...
          <tbody>
            <tr><td>3時間券<span>*4</span></td><td>¥2,310</td><td>¥1,980</td></tr>
            <tr><td>1日券<span>*4</span><br />（開店〜閉店）</td><td>¥2,530</td><td>¥2,200</td></tr>
          </tbody>
        </table>
        <hr />
        <h3>回数券・パスポート</h3>
        <table className="alt">
          ...
          <tbody>
            <tr><td>回数券<br />一般と学生・キッズともに同料金です<span>*5</span></td><td colspan="2">10回券：¥17,600<br />5回券：¥8,800</td></tr>
            <tr><td>月パス</td><td>¥13,860</td><td>¥9,900</td></tr>
            <tr><td>サブスクパス *6<br />＜<a href="https://forms.gle/2VKKcP2xb2TKce299">お申込みフォーム</a>＞</td><td>¥12,890</td><td>¥9,240</td></tr>
        ...
        <p className="small">
          ...
          *4:混雑状況によって入場制限をする場合がございます。尚、2023年4月1日より、予約制廃止および人数制限解除となっております。<br /> 
          *5:回数券は施設利用料のみに利用できます。利用期限はご購入日から2年間です。受け取りは購入者のみで、回数券使用開始後（会員番号＆氏名記入後）の譲渡はできません。<br />
          *6:▼ご購入の流れ<br />
