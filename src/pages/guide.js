...
※混雑状況によって入場制限をする場合がございます。事前に<a href="https://docs.google.com/forms/d/e/1FAIpQLSdkfqWiBSGoy5viXovQ6GVxJgJQ_P4uOHisevQjkfCzAch6mw/viewform" target="_blank">予約フォーム</a>でご予約いただくとスムーズです（「開店〜15時」の枠で予約）。
    ...
    <section id="three">
      <div className="inner">
        ...
        <dl>
          <dt>館内では原則マスクを着けてください（2022.6.7更新)</dt>
          <dd>課題トライ時はマスクを外していただいて構いません。</dd>
          <dd>未就学児以下のお子様はマスクの着用は不要です。</dd>
          <dd>いずれに場合でも、ジムスタッフから個別にご依頼がある場合には、ご自身の判断に関わらず必ず指示に従ってください。</dd>
        </dl>
        <dl>
